...
public class ModeloDatos {
    ...
    public void abrirConexion() {
        ...
        try {
            ...
            String dbHost = System.getenv("DATABASE_HOST") == null ? System.getProperty("DATABASE_HOST")
                    : System.getenv("DATABASE_HOST");
            String dbPort = System.getenv("DATABASE_PORT") == null ? System.getProperty("DATABASE_PORT")
                    : System.getenv("DATABASE_PORT");
            String dbName = System.getenv("DATABASE_NAME") == null ? System.getProperty("DATABASE_NAME")
                    : System.getenv("DATABASE_NAME");
            String dbUser = System.getenv("DATABASE_USER") == null ? System.getProperty("DATABASE_USER")
                    : System.getenv("DATABASE_USER");
            String dbPass = System.getenv("DATABASE_PASS") == null ? System.getProperty("DATABASE_PASS")
